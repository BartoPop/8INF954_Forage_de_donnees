...
public class J48Mod
 ...
 private static String alphastring="0" ;
  private  Window window = Window.getInstance();
  static public String getalpha(){
  return alphastring;}
  ...
  public void buildClassifier(Instances instances) 
    ...
    alphastring = jop.showInputDialog(null, "Veuillez donner la valeur de alpha !", JOptionPane.QUESTION_MESSAGE);
	
	if((alphastring.equals("1")) && (Double.parseDouble(alphastring) <=0)){ window.setWindow(0);}
	else {
	window.setWindow(1);
	};
    }
